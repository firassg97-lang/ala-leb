...
TextTheme _buildTextTheme(Brightness brightness) {
  final baseColor      = brightness == Brightness.light ? textPrimary : Colors.white;
  final secondaryColor = brightness == Brightness.light ? textSecondary : Colors.white70;
  return TextTheme(
    ...
    bodySmall:     GoogleFonts.poppins(fontSize: 12, color: secondaryColor),
